...
const FeedbackList = ({ triggerRefresh }) => {
  ...
  return (
    <section id="feedback-list" className="bg-white dark:bg-zinc-950 py-16 px-6 border-b border-zinc-100/60 dark:border-zinc-900/60 transition-colors duration-300 overflow-hidden">
                ...
                >
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    {item.avatar ? (
                      ...
                      <div className="w-12 h-12 rounded-full bg-zinc-100 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 flex items-center justify-center text-base font-bold text-zinc-950 dark:text-white shadow-xs select-none">
                        {item.name ? item.name.charAt(0).toUpperCase() : "?"}
                      </div>
                    )}

                    <div className="min-w-0">
                      <h3 className="text-sm font-semibold text-zinc-950 dark:text-white tracking-tight break-words">
                        {item.name}
                      </h3>
